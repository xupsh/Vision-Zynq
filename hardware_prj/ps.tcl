proc getPresetInfo {} {
  return [dict create name {v4l2} description {v4l2}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {v4l2} ]
}
...
return [dict create \
    ...
    CONFIG.PCW_M_AXI_GP0_FREQMHZ {76}  \
    ...
    CONFIG.PCW_S_AXI_HP0_FREQMHZ {96}  \
    CONFIG.PCW_S_AXI_HP1_FREQMHZ {108}  \
    ...
    CONFIG.PCW_IMPORT_BOARD_PRESET {C:/zhenyul/Xilinx_Proj_Sep_II/IP_Test_Project/ZYBO_zynq_def.xml}  \
