...
generate_target {synthesis implementation} \
  [get_files  $project_name.srcs/sources_1/bd/design_1/design_1.bd]

make_wrapper -files [get_files $project_name.srcs/sources_1/bd/design_1/design_1.bd] -top
import_files -force -norecurse -fileset sources_1 ./design_1_wrapper.v
